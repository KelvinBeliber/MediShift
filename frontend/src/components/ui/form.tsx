...
function FormItem({ className, ...props }: React.ComponentProps<"div">) {
  ...
  // MediShift: upstream FormControl always points aria-describedby at the
  // description id, even on fields that render no <FormDescription> — a
  // dangling IDREF that axe flags as aria-valid-attr-value. FormDescription
  // registers itself here so FormControl can reference only what exists.
